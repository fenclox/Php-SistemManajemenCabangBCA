            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i> Pegawai<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="index.php?hal=pgw">Data Pegawai</a>
                                </li>
                                <li>
                                    <a href="index.php?hal=tpgw">Tambah Pegawai</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
