        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <!-- Data Cabang -->
                    <?php
                    $query="SELECT bank.*, pegawai.* from pegawai, bank where bank.kd_bank=pegawai.kd_bank and level='1' order by nip asc";
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Profil Supervisor</h4>
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Ubah Supervisor</h4>
                        </div>
                        <div class="modal-body">
                        <form method="post" data-toggle="modal" enctype="multipart/form-data" action="data/spv/proses.php">
                            <!-- Ubah Data ******************************************************************************-->
                                <span id="dub"></span>
                            <!-- End Ubah Data *****************************************************************************-->
                        </div>
            ...
            <div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form method="post" action="data/spv/proses.php">
                                <input type="hidden" id="dspv" name="kode" value="">
        ...
        <script>
            function lihatdata(nip){
                var ajaxbos = new XMLHttpRequest();
                    ...
                    ajaxbos.open("GET","data/spv/detil.php?q="+nip+"&s=#",true);
                    ajaxbos.send();
            }
            ...
            function ubahdata(nip){
                var ajaxbos = new XMLHttpRequest();
                    ...
                    ajaxbos.open("GET","data/spv/ubah.php?q="+nip+"&s=#",true);
                    ajaxbos.send();
            }

            function hapusdata(nip){
                document.getElementById('dspv').value=nip;
            }
        </script>
