                        <h3 class="page-header">Tambah Supervisor</h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- *************************************Content************************************* -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" enctype="multipart/form-data" action="data/spv/proses.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" name="password" placeholder="Kata sandi terisi stomatis" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label>Foto</label>
